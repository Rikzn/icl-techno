...
export default function() {
    const realisedProjectsSlider = document.querySelector('.js-about-company-slider');
    ...
    const swiperWrapper = realisedProjectsSlider.querySelector('.about-company__advantages-slider-wrapper');
